...
def Image1():
    image = cv2.imread('H:/Beat-Saber/display image/two2.jpg')
    width = 640
    height = 480
    dim = (width, height)
    ...
    return image
def Image2():
    image1 = cv2.imread("H:/Beat-Saber/display image/one.jpg")
    width = 640
    height = 480
    dim = (width, height)
    image = cv2.resize(image, dim, interpolation = cv2.INTER_AREA)
    return image
def Image3():
    image1 = cv2.imread("H:/Beat-Saber/display image/three.jpg")
    width = 640
    height = 480
    dim = (width, height)
    image = cv2.resize(image, dim, interpolation = cv2.INTER_AREA)
    return image
def Image4():
    image1 = cv2.imread("H:/Beat-Saber/display image/four.jpg")
    width = 640
    height = 480
    dim = (width, height)
    image = cv2.resize(image, dim, interpolation = cv2.INTER_AREA)
...
def Image5():
    image1 = cv2.imread("H:/Beat-Saber/display image/five.jpg")
    width = 640
    height = 480
    dim = (width, height)
    image = cv2.resize(image, dim, interpolation = cv2.INTER_AREA)
...
# VIDEO CAPTURE
	...
	while 1:
		...
		numpy_horizontal1  = np.hstack((thresh1,img2))
		numpy_horizontal2  = np.hstack((img,Image1()))
		#marge = np.concatenate((numpy_horizontal1[1:1,None],numpy_horizontal2[0:0,None]),axis=1)
		#numpy_vertical =  np.vstack((marge))
